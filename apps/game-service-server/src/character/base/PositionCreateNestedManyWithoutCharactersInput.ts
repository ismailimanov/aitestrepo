...
@InputType()
class PositionCreateNestedManyWithoutCharactersInput {
...
export { PositionCreateNestedManyWithoutCharactersInput as PositionCreateNestedManyWithoutCharactersInput };
